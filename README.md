...
<a href="https://pkg.go.dev/github.com/stainless-sdks/ark-go"><img src="https://pkg.go.dev/badge/github.com/stainless-sdks/ark-go.svg" alt="Go Reference"></a>
...
```go
import (
	"github.com/stainless-sdks/ark-go" // imported as ark
)
```
...
```sh
go get -u 'github.com/stainless-sdks/ark-go@v0.0.1'
```
...
The ark library uses the [`omitzero`](https://tip.golang.org/doc/go1.24#encodingjsonpkgencodingjson)
...
See the [full list of request options](https://pkg.go.dev/github.com/stainless-sdks/ark-go/option).
...
`*ark.Error`. This contains the `StatusCode`, `*http.Request`, and
...
We also provide a helper `ark.File(reader io.Reader, filename string, contentType string)`
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/ark-go/issues) with questions, bugs, or suggestions.
